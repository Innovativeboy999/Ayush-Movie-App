...
import com.example.ayushmoviesapplication.ui.Activities.MovieDetails;
    ...
    public class NowPlayingAdapter extends PagedListAdapter<Movie, RecyclerView.ViewHolder>
    {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new NowPlayingAdapterViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_view_movies_card,parent,false));
        }

        @Override
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            Movie movie = getItem(position);
            if(holder instanceof NowPlayingAdapterViewHolder)
            {
                ((NowPlayingAdapterViewHolder) holder).bind(movie);
            }
        }
        ...
        class NowPlayingAdapterViewHolder extends RecyclerView.ViewHolder
        {
            private ItemViewMoviesCardBinding binding;
            public NowPlayingAdapterViewHolder(@NonNull View itemView) {
                super(itemView);
